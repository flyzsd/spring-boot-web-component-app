 ...
 */
// @ts-ignore
import {render, ShadyRenderOptions} from '../webjars/lit-html/lib/shady-render.js';
...
// @ts-ignore
export {html, svg, TemplateResult, SVGTemplateResult} from '../webjars/lit-html/lit-html.js';
